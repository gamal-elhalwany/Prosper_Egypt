                        ...
                        <div class="row">
                            <div class="col-md-12 col">
                                ...
                                <ul class="slider-list">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Explore Our Lines Of Business</a>
                    ...
                    <div class="row flex-lg-row flex-column align-items-center">
                        ...
                        <div
                            ...
                            <div class="img-wrapper">
                                <img src="{{asset('storage/images/logos/sector_logo1.png')}}" class="img-fluid" alt="Sector Logo">
                            </div>
                ...
                <div class="group">
                    <div class="row flex-lg-row flex-column align-items-center">
                        ...
                        <div
                            class="col-lg-10 col-12 d-flex flex-lg-row flex-column align-items-center justify-content-between mb-3 mb-lg-0">
                            <div class="img-wrapper">
                                <img src="{{asset('storage/images/logos/sector_logo3.png')}}" class="img-fluid" alt="Sector Logo">
                            </div>
                            <div class="middle ms-lg-3 mt-3 mt-lg-0 text-center text-lg-start">
                ...
                <div class="group">
                    <div class="row flex-lg-row flex-column align-items-center">
                        ...
                        <div
                            class="col-lg-10 col-12 d-flex flex-lg-row flex-column align-items-center justify-content-between mb-3 mb-lg-0">
                            <div class="img-wrapper">
                                <img src="{{asset('storage/images/logos/sector_logo4.jpeg')}}" class="img-fluid" alt="Sector Logo">
                            </div>
                            <div class="middle ms-lg-3 mt-3 mt-lg-0 text-center text-lg-start">
                ...
                <div class="contact-form">
                    ...
                    <form class="" action="" method="">
                        ...
                        <div class="group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="+0121287255">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <select id="inputState" class="form-control subject">
